    ...
    def compute_objectives(self, predictions, batch, stage):
        ...
        if self.is_ctc_active(stage):
            ...
            loss_ctc = self.hparams.ctc_cost(
                predictions["ctc_logprobs"], tokens, self.lens, tokens_lens
            )
